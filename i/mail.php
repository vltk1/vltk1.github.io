...
$from = "chikako_motoi@dsd.dokidoki-gw.com";
...
$subject = "【リゾートホテル優待券専用予約サイト】お問い合わせ";
...
$re_subject = "【リゾートホテル優待券専用予約サイト】送信ありがとうございました";
...
})(window, document, 'script', 'dataLayer', 'GTM-TVWTJZ8');
</script>
...
(function(w, d, s, l, i) {
	...
	j.src = 'https://www.googletagmanager.com/gtm.js?id=' + i + dl;
	f.parentNode.insertBefore(j, f);
})(window, document, 'script', 'dataLayer', 'GTM-KCDJ2Q3');
</script>
<!-- End Google Tag Manager2 -->

	<meta http-equiv="content-type" content="text/html; charset=utf-8">
	<meta name="viewport" content="width=device-width,initial-scale=1.0,maximum-scale=1.0">
	<title>共立メンテナンス株主専用リゾートホテル優待券専用予約サイト</title>
	<meta name="keywords" content="">
	<meta name="description" content="">
	<meta name="robots" content="noindex">
	<meta name="format-detection" content="telephone=no">
	<link type="text/css" rel="stylesheet" href="/sh_resortyutai/css/screen.css">
	<link rel="stylesheet" type="text/css" href="/sh_resortyutai/inquiry/css/style.css">
	<link href="https://hotespa.net/common/css/header.css" rel="stylesheet" type="text/css">
	<!--共通footer_css-->
	<link href="https://hotespa.net/common/css/footer.css" rel="stylesheet" type="text/css">
	<!--共通footer_css-->
...
<body id="screen" >
	...
	<noscript>
		<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TVWTJZ8" height="0" width="0" style="display:none;visibility:hidden"></iframe>
	</noscript>
	<!-- End Google Tag Manager (noscript) -->
	<!-- Google Tag Manager (noscript)2 -->
	<noscript>
		<iframe src="https://www.googletagmanager.com/ns.html?id=GTM-KCDJ2Q3" height="0" width="0" style="display:none;visibility:hidden"></iframe>
	</noscript>
	<!-- End Google Tag Manager (noscript)2-->
	<main class="wrapper" id="resize">
		<!--
		INCLUDE HEADER -->
		<?php include($_SERVER['DOCUMENT_ROOT']."/sh_resortyutai/include/header.php");?>

		<div class="mainContainer step2">
			...
			<div class="contact-main">
				<p class="contact-main--text">
					お問い合わせフォームでは空室確認、<br class="is-sp">ご予約・変更・キャンセルは <br>出来かねますのでご了承くださいませ。　
				</p>
				<ul class="contact-step contact-step2">
					<li class="contact-tabs">
						<span>STEP 1 入力</span>
					</li>
					<li class="active" class="contact-tabs">
						<span>STEP 2 確認</span>
					</li>
					<li  class="contact-tabs">
						<span>STEP 3 完了</span>
...
?>
					...
					<div class="btn-form">
						<input type="button" onClick="history.back()" value="前にもどる">
...
<!-- ▼ Footerその他コンテンツなど　※編集可 ▼-->
	...
	<!--
		INCLUDE FOOTER -->
		<?php include($_SERVER['DOCUMENT_ROOT']."/sh_resortyutai/include/footer.php");?>
	</main>
</body>
</html>
<?php
...
function confirmOutput($arr){
	...
	foreach($arr as $key => $val) {
		...
		$html .= '<div class="form-group">';
			...
			$html .= '<p class="value-form">'.mb_convert_kana($out,"K", $encode).'</p>';
		$html .= '</div>';
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	...
	$adminBody .="【リゾートホテル優待券専用予約サイト】からメールが届きました\n\n";
	$adminBody .="＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝＝\n\n";
